...
Nine open, seventeen closed — **the whole build queue closed on 2026-08-03**
...
⚠️ **THREE ARE UNRULED — M13 and M14 (2026-08-04) and M15 (2026-08-05).** This table read
...
| **M13** | The merge leg's verifier encodes pre-M8 behaviour, so an adopted merge reports a FALSE failure | `ops/merge-fixture.js:469` | **OPEN — filed 2026-08-04, UNRULED. CONFIRMED LIVE 2026-08-05** — no longer a derived claim; the false failure was reproduced exactly. Verifier correctness, and this repo has a precedent (`2dec78c`) for taking that seriously; see below |
...
| **M15** | The panel's `created` column is the AUTH record's creation time, so a re-bootstrapped account reads days old | `ops/project.js:63`, `ops/panel.html:38` | **OPEN — filed 2026-08-05, UNRULED. OBSERVED live** during smoke-test step E1; label accuracy in a destructive tool. See below — and read M7's ruling first |
...
⚠️ **M13, M14 and M15 are NEW and are NOT "judged fine to leave" — they are
UNRULED.** (M13/M14 filed 2026-08-04; **M15** 2026-08-05.) They sit in this table because it is where minors live, not
