...
// re-delivers on every prefs echo, though its only readers are the server-side
// notifier and the client's stale-token cull. This copies every user's tokens to
// pushTokens/{uid}/{token} and nulls the legacy userPrefs/{uid}/pushTokens copy,
