...
export const TELEGRAM_ENABLED = false; // Experimental Telegram Mini App + bot. TRUE on the feature branch only; flip to false at merge. Spec: docs/superpowers/specs/2026-07-02-telegram-adaptation-design.md
